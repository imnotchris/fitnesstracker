...
export const PLANS = [
  {
    ...
    exercises: [
      ...
      { name: 'Lat Pulldown',        muscleGroup: 'Back / Biceps',   sets: 3, reps: 6, weight: 65  },
    ],
  },
  {
    id: 'day2',
    ...
    exercises: [
      ...
      { name: 'Seated Cable Row',              muscleGroup: 'Back / Biceps',       sets: 3, reps: 8, weight: 60 },
    ],
  },
  {
    id: 'day3',
    ...
    exercises: [
      ...
      { name: 'Single-Leg RDL',           muscleGroup: 'Hamstrings / Glutes', sets: 3, reps: 10, weight: 30, note: '2×30kg DBs — each leg, left first' },
