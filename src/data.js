...
export const PLANS = [
  {
    ...
    color: '#3b82f6',
    exercises: [
      { name: 'Barbell Back Squat',  muscleGroup: 'Quads / Glutes',  sets: 3, reps: 5, weight: 95  },
      { name: 'Trap Bar Deadlift',   muscleGroup: 'Posterior Chain', sets: 3, reps: 5, weight: 108 },
      { name: 'Barbell Bench Press', muscleGroup: 'Chest / Triceps', sets: 3, reps: 5, weight: 70  },
      { name: 'Iso Lat Pulldown',    muscleGroup: 'Back / Biceps',   sets: 3, reps: 6, weight: 40, note: '40kg per side' },
      { name: 'Dumbbell Curl',       muscleGroup: 'Biceps',          sets: 2, reps: 8,  weight: 10, note: 'Full ROM — supinate at top', inc: 1 },
      { name: 'Ab Wheel',            muscleGroup: 'Core',            sets: 3, reps: 8,  weight: 0,  note: 'Full rollout — brace hard, don\'t let lower back arch' },
    ],
  },
  {
    id: 'day2',
    ...
    exercises: [
      ...
      { name: 'Romanian Deadlift',             muscleGroup: 'Hamstrings / Glutes', sets: 3, reps: 8, weight: 70 },
      { name: 'Barbell Overhead Press',        muscleGroup: 'Shoulders / Triceps', sets: 3, reps: 6, weight: 40 },
      { name: 'Seated Cable Row',              muscleGroup: 'Back / Biceps',       sets: 3, reps: 8, weight: 65, note: 'Cable stack number 13 (÷5 to get pin)' },
      { name: 'Hammer Curl',                  muscleGroup: 'Biceps / Forearms',   sets: 2, reps: 12, weight: 15, note: 'Neutral grip — targets brachialis', inc: 1 },
    ],
  },
  {
    id: 'day3',
    ...
    exercises: [
      ...
      { name: 'Single-Leg RDL',           muscleGroup: 'Hamstrings / Glutes', sets: 3, reps: 10, weight: 20, note: 'Each leg — left leg first', inc: 2.5 },
      ...
      { name: 'Cable Crunch',             muscleGroup: 'Core',                sets: 3, reps: 15, weight: 25, note: 'Cable number 5 — kneel, crunch down to floor', inc: 2.5 },
    ],
  },
]
...
// ── Nutrition ─────────────────────────────────────────────────
// Phase 1 — Build (19 Aug 2026 → 15 Feb 2027): 2800 kcal · 215g protein
// Phase 2 — Cut  (15 Feb 2027 → 1 May 2027):   2300 kcal · 230g protein
export const DAILY_TARGETS = { kcal: 2800, protein: 215 }
...
export const INIT_PRS = {
  ...
  'Barbell Bench Press':          { weight: 70,  reps: 5,  date: '2026-08-19' },
  'Iso Lat Pulldown':             { weight: 40,  reps: 6,  date: '2026-08-19' },
  'Barbell Bulgarian Split Squat':{ weight: 40,  reps: 8,  date: '2026-08-19' },
  'Romanian Deadlift':            { weight: 70,  reps: 8,  date: '2026-08-19' },
  'Barbell Overhead Press':       { weight: 40,  reps: 6,  date: '2026-08-19' },
  'Seated Cable Row':             { weight: 65,  reps: 8,  date: '2026-08-19' },
  'Leg Press':                    { weight: 100, reps: 12, date: '2026-08-19' },
  ...
  'Cable Crunch':                 { weight: 25,  reps: 15, date: '2026-08-19' },
}
